...
infoTexture:SetPoint("TOPLEFT", enabledButton, "TOPLEFT", 100, -65);
infoTexture:SetSize(256, 37);
infoTexture:SetTexCoord(0,1,0,0.7);

local yellTexture = IRT_CouncilofBloodOptions:CreateTexture(nil, "BACKGROUND");
yellTexture:SetTexture("Interface\\addons\\InfiniteRaidTools\\Res\\tcob.tga");
yellTexture:SetPoint("TOPLEFT", infoTexture, "TOP", 0, -40);
yellTexture:SetSize(52, 94);
yellTexture:SetTexCoord(0,0.81,0,0.73);
