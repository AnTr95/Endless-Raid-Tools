...
L.OPTIONS_PAINSMITHRAZNAL_TITLE = "Painsmith Raznal Module";
L.OPTIONS_PAINSMITHRAZNAL_INFO = "Painsmith Raznal Module";
L.OPTIONS_PAINSMITHRAZNAL_PREVIEW = "Painsmith Raznal Module";
