...
L.OPTIONS_CONSUMABLECHECK_PREVIEW = "|cFFFFFFFFPreview of consumable check|r";
L.OPTIONS_CONSUMABLECHECK_INFO = "Shows if the player has food, flask and rune. In addition classes that has buffs can see if players are missing their buff.\nThe picture is taken from a warrior point of view other classes would see their buff or none if they do not have any.";
...
L.OPTIONS_COUNCILOFBLOOD_INFO = "|cFF00FFFFDanse Macabre:|r Makes the button glow of the correct dance move during Danse Macabre.\n|cFF00FF00Action Button Support:|r Blizzard Action Buttons, Bartender4, ElvUI, ElvUI_SLE. Contact me about missing addon support.\n|cFF00FFFF(Mythic) Dancing Fever:|r Tells the classes that can dispel diseases (|cff00fe97Monk|r/|cfff38bb9Paladin|r/|cFFFFFFFFPriest|r) when it is safe to dispel dancing fever.";
L.OPTIONS_COUNCILOFBLOOD_DM = "Danse Macabre Enabled";
L.OPTIONS_COUNCILOFBLOOD_DF = "Dancing Fever Enabled";
L.OPTIONS_COUNCILOFBLOOD_PREVIEW = "Preview of the glowing buttons during Danse Macabre and dispel text for |cff00fe97Monk|r/|cfff38bb9Paladin|r/|cFFFFFFFFPriest|r";
...
L.OPTIONS_SLUDGEFIST_INFO = "Boulders spawn around the pillar that is destroyed by Hateful Gaze and you can predetermine marks for each of the corners i.e.\nStar=back right, circle=back left, diamond=front right and triangle=front left. The addon marks and assigns chain paired players prioritizing tanks then healers then ranged to soak the boulders. One person will be told to take both a large and then a small soak using a defensive while their partner will be told just to take a small soak.\nThe addon also tells you if you are more than 6 yards apart just as a warning.";
L.OPTIONS_SLUDGEFIST_PREVIEW = "";
