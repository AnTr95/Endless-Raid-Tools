...
L.OPTIONS_COUNCILOFBLOOD_INFO = "|cFF00FFFFDancing Fever:|r Tells the classes that can dispel diseases (|cff00fe97Monk|r/|cfff38bb9Paladin|r/|cFFFFFFFFPriest|r) when it is safe to dispel dancing fever. The player affected by Dancing Fever will yell SAFE or NOT SAFE as their state changes.\n\n|cFF00FFFFConfig:|r The popup can be individually moved, resized and reset to default positions in the general options.";
L.OPTIONS_COUNCILOFBLOOD_PREVIEW = "|cFFFFFFFFPreview of the dispel text for |cff00fe97Monk|r/|cfff38bb9Paladin|r/|cFFFFFFFFPriest|r |cFFFFFFFFwhen a player is safe to dispel and updates in real time as well as the yell of the player affected by Dancing Fever and their state got changed to safe.|r";
