...
L.OPTIONS_CONSUMABLECHECK_INFO = "Shows if the player has food, flask and rune in addition to that classes that has buffs can see if players are missing their buff.\nThe picture is taken from a warrior point of view other classes would see their buff or none if they do not have any.";
