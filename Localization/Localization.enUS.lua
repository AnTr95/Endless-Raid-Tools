...
L.OPTIONS_COUNCILOFBLOOD_INFO = "|cFF00FFFFDanse Macabre:|r Makes the button glow of the correct dance move during Danse Macabre.\n|cFF00FFFF(Mythic) Dancing Fever:|r Tells the healers when it is safe to dispel dancing fever and tells players that are too close to a player debuffed with dancing fever to move.";
