...
L.OPTIONS_CONSUMABLECHECK_PREVIEW = "|cFFFFFFFFPreview of consumable check from |r|cff3ec6eaMage|r |cFFFFFFFFPoV (can buff) and |r|cfff38bb9Paladin|r |cFFFFFFFFPoV (cant buff)|r";
