...
L.OPTIONS_CONSUMABLECHECK_PREVIEW = "|cFFFFFFFFPreview of consumable check from |cffc59a6cWarrior|r PoV (can buff) and |cfff38bb9Paladin|r PoV (cant buff)|r";
L.OPTIONS_CONSUMABLECHECK_INFO = "Shows if the player has food, flask and rune. In addition classes that has buffs can see if players are missing their buff.\nThe top picture is taken from a |cffc59a6cwarrior|r point of view, other classes would see their buff or none if they do not have any.\nThe bottom picture is taken from a |cfff38bb9paladin|r which can not buff and there for no buffs are shown.";
