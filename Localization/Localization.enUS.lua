...
L.OPTIONS_GENERAL_INFO = "This is the popup text that Interrupt, Innervate, Bonus Roll and boss modules are using. Move the popup to anywhere you want on your screen and change the size after your preference.";
