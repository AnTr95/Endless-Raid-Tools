	...
	elseif "CALENDAR_UPDATE_PENDING_INVITES" and EnRT_CalendarNotificationEnabled then
		...
		if invites > 0 then
			...
			C_Timer.After(1, function()
				PlaySoundFile("Interface\\AddOns\\EndlessRaidTools\\Sound\\CalendarNotification\\calnotyouhave.ogg", "master")
				C_Timer.After(2, function()
					PlaySoundFile("Interface\\AddOns\\EndlessRaidTools\\Sound\\CalendarNotification\\calnot" .. invites .. ".ogg", "master")
					C_Timer.After(2, function()
						PlaySoundFile("Interface\\AddOns\\EndlessRaidTools\\Sound\\CalendarNotification\\calnotinvites.ogg", "master")
